      ...
      <div className="max-w-screen-xl mx-auto py-10 lg:py-14">
        <div className="flex flex-col items-center px-4 sm:px-6 lg:px-4">
          ...
          <div className="text-lg text-gray-800 w-full">
            ...
            <p className="mt-2 leading-loose">For the purposes of these Terms and Conditions:</p>
            ...
            <h2 className="text-2xl font-bold mt-8">Acknowledgement</h2>
            <p className="mt-2 leading-loose">
            ...
            <h2 className="text-2xl font-bold mt-8">Disputes Resolution</h2>
            <p className="mt-2 leading-loose">
            ...
            <h2 className="text-2xl font-bold mt-8">For European Union (EU) Users</h2>
            <p className="mt-2 leading-loose">
            ...
            <h2 className="text-2xl font-bold mt-8">United States Legal Compliance</h2>
            <p className="mt-2 leading-loose">
            ...
            <h2 className="text-2xl font-bold mt-8">Severability and Waiver</h2>
            <h2 className="text-2xl font-bold mt-8">Severability</h2>
            <p className="mt-2 leading-loose">
            ...
            <h2 className="text-2xl font-bold mt-8">Waiver</h2>
            <p className="mt-2 leading-loose">
            ...
            <h2 className="text-2xl font-bold mt-8">Translation Interpretation</h2>
            <p className="mt-2 leading-loose">
            ...
            <h2 className="text-2xl font-bold mt-8">Changes to These Terms and Conditions</h2>
            <p className="mt-2 leading-loose">
            ...
            <ul className="list-disc list-inside">
              <li className="ml-2 mb-3">By email: support@example.com</li>
              <li className="ml-2 mb-3">By phone number: 408.996.1010</li>
            </ul>
          </div>
        </div>
      </div>
