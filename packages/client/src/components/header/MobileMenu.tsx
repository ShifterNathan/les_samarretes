      ...
      <Dialog as="div" className="relative z-50" onClose={setMobileMenuOpen}>
        ...
        <div className="fixed inset-0 overflow-hidden">
          <div className="absolute inset-0 overflow-hidden">
            <div className="pointer-events-none fixed inset-y-0 right-0 flex min-w-full pl-10 sm:pl-16">
              <Transition.Child
                as={Fragment}
                ...
                <Dialog.Panel className="pointer-events-auto w-screen max-w-sm">
                  <div className="flex h-full flex-col overflow-y-scroll bg-white py-6 shadow-xl">
                    ...
                    <div className="relative mt-6 flex-1 px-4 sm:px-6">
                      <Dialog.Panel className="fixed inset-y-0 right-0 z-50 w-106 overflow-y-auto bg-white p-6 ">
